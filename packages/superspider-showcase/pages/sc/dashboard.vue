      ...
      <el-row>
        ...
        >
          ...
          <el-form-item label="密码">
            <el-input v-model="submitForm.password" type="password" />
          </el-form-item>
          <el-form-item label="消息ID">
            <el-input v-model="submitForm.id" />
          </el-form-item>
          <el-form-item label="翻译">
            <el-input v-model="submitForm.tr" />
          </el-form-item>
          <el-form-item>
            <el-button @click="startHide"> 隐藏消息 </el-button>
            <el-button type="primary" @click="startSubmit">
              提交翻译
            </el-button>
          </el-form-item>
        </el-form>
